...
public class Principal extends Application {
  ...
  /* ***************************************************************
 * Metodo: main
 * Funcao: Eh o metodo responsavel por reunir todas as classes que serao compiladas e carregar o
 * metodo launch() para que o JavaFX seja executado
 ...
 *************************************************************** */
  ...
  public void start(Stage primaryStage) throws Exception {
    ...
    Image icon = new Image("/img/icone.jpg");  // Instancia o icone do projeto

    primaryStage.getIcons().add(icon);  // Adiciona o icone no Stage
    primaryStage.setTitle("Projeto Trafego Autonomo");  // Adiciona um titulo no Stage
